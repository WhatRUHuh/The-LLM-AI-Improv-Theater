...
export type SectionKey = 'singleUserSingleAISetup' | 'singleUserSingleAIInterface' | 'singleUserMultiAISetup' | 'singleUserMultiAIInterface' | 'directorModeSetup' | 'directorModeInterface' | 'scripts' | 'characters' | 'ai-config' | 'history' | 'settings'; // <-- 添加了导演模式的 key
